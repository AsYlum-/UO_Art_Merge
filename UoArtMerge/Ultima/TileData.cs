...
namespace UoArtMerge.Ultima
{
    ...
    public struct LandData
    {
        ...
        public LandData(string name, TileData data, int TexID, TileFlag flags, int unk1)
        {
            m_tileData = data;
            m_Name = name;
            m_TexID = (short)TexID;
        ...
        public unsafe LandData(NewLandTileDataMul mulstruct, TileData data)
        {
            ...
            m_Name = data.ReadNameString(mulstruct.name);
        }
        ...
        public void ReadData(string[] split)
        {
            int i = 1;
            m_Name = split[i++];
            m_TexID = (short)m_tileData.ConvertStringToInt(split[i++]);
            m_Unk1 = m_tileData.ConvertStringToInt(split[i++]);
            m_Flags = 0;
    ...
    public struct ItemData
    {
        ...
        public void ReadData(string[] split)
        {
            ...
            m_Animation = (short)m_tileData.ConvertStringToInt(split[4]);
    ...
    public sealed class TileData
    {
        ...
        private byte[] _stringBuffer = new byte[20];
